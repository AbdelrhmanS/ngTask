...
(function() {
	...
	describe('controllers ', function() {
		...
		beforeEach(inject(function(_$controller_) {
			...
			$controller('UsersController',{$scope:scope , usersData: usersData});

		}));

		it('Test page number is defined ', function() {
			expect(scope.page).toBeDefined();
		});
		it('Test users object is defined ', function() {
			expect(scope.users).toBeDefined();
		});
		it('Test first page number  ', function() {
			expect(scope.page).toBe(1);
		});
		it('Test users object that contain data ', function() {
